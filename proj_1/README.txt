This project case is about triangulating a square region. The side is 1.
...
$ run 200 15
# This will run the case for total number of points = 200 and boundary points = 15 * 4 = 60.
